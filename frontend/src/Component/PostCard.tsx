...
export const PostCard=({title,content,publisheddate,blogid}:{title:string,content:string,publisheddate:Date,blogid:number})=>{
    ...
    return <Link to={`/YourBlog/${blogid}`}> <div className="p-5 px-8 bg-gradient-to-r from-slate-600 to-white/20 mt-6 hover:bg-slate-600 rounded-xl transform transition duration-200 hover:scale-110 ">
        ...
        <div className="my-1.5 text-xs font-normal text-gray-200 opacity-50">{date}</div>
