          ...
          <div className="flex items-center h-full w-full bg-gradient-to-l from-black/10 via-black/80 to-black pl-40">
            <div className="flex flex-col gap-4  text-white">
              ...
              <div className="-mt-4 ">
                ...
                <div className="mt-8"><button onClick={handleclickevent} className="flex items-center gap-2 px-3 py-2 bg-gray-900 hover:bg-gray-950 bg-opacity-80 rounded-lg  "><p className="text-md font-semibold bg-gradient-to-r from-white  to-slate-500 text-transparent bg-clip-text">get started </p><MdOutlineStart className="w-6 h-4 opacity-70"/></button></div>
              </div>
            </div>
          </div>
        </div>
